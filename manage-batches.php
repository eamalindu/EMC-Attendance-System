...
<div class="container p-5">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            //TODO: if batch already completed disable edit button
...
<div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="offcanvasExample"
    ...
    <div class="offcanvas-body">
        ...
        <div class="mb-2">
            <label for="bStartTime" class="form-label">Start Time</label>
            <input type="time" class="form-control rounded-0" id="bStartTime" placeholder="L3-DIIT-01">
        </div>
        <div class="mb-2">
            <label for="bEndTime" class="form-label">End Time</label>
